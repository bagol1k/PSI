...
#' #### 📌 Przetwarzanie i oczyszczanie tekstu <br>
#'
...
#' - analiza i dopasowanie sentymentu do konkrennych słów dla słowników Loughran i NRC
...
#wektor ze ścieżkami dokumentów
docs <- c(
...
knitr::include_graphics(zdjecie)#dołączenie zdjęcia do raportu
...
#' # Uwagi
#' 
#' Należy zwracać uwagę na interwały w jakich są przedstawiane wykresy giełdowe,
#' niektóre wykresy mają niskie interwały, niektóre wysokie przez brak dostępu
#' do wykresów o niższych (bardziej czytelnych) interwałach.
#' Na zdjęciu strzałka wskazuje moment lub dzień wystąpienia Powella.
#' Na niskich interwałach należy wypatrywać korelacji między wykresem giełdowym a zmianą sentymentu w czasie,
#' na wysokich interwałach należy patrzeć na ogólny wpływ wypowiedzi na dany dzień i następne dni.
